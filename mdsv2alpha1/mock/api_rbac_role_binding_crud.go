...
func (m *RBACRoleBindingCRUDApi) AddRoleForPrincipal(ctx context.Context, principal, roleName string, scope github_com_confluentinc_mds_sdk_go_public_mdsv2alpha1.Scope) (*net_http.Response, error) {
...
func (m *RBACRoleBindingCRUDApi) DeleteAllRolesForPrincipal(ctx context.Context, principal string, scope github_com_confluentinc_mds_sdk_go_public_mdsv2alpha1.Scope) (*net_http.Response, error) {
...
func (m *RBACRoleBindingCRUDApi) DeleteRoleForPrincipal(ctx context.Context, principal, roleName string, scope github_com_confluentinc_mds_sdk_go_public_mdsv2alpha1.Scope) (*net_http.Response, error) {
...
func (m *RBACRoleBindingCRUDApi) GetRoleResourcesForPrincipal(ctx context.Context, principal, roleName string, scope github_com_confluentinc_mds_sdk_go_public_mdsv2alpha1.Scope) ([]github_com_confluentinc_mds_sdk_go_public_mdsv2alpha1.ResourcePattern, *net_http.Response, error) {
