...
func (m *TokensAndAuthenticationApi) GetToken(ctx context.Context) (github_com_confluentinc_mds_sdk_go_public_mdsv2alpha1.AuthenticationResponse, *net_http.Response, error) {
	m.lockGetToken.Lock()
