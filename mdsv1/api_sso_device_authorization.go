...
func (a *SSODeviceAuthorizationApiService) CheckDeviceAuth(ctx _context.Context, checkDeviceAuthRequest CheckDeviceAuthRequest) (CheckDeviceAuthResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  CheckDeviceAuthResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/security/1.0/oidc/device/check-auth"
	...
	// body params
	localVarPostBody = &checkDeviceAuthRequest
...
func (a *SSODeviceAuthorizationApiService) ExtendDeviceAuth(ctx _context.Context) (ExtendAuthResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ExtendAuthResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/security/1.0/oidc/device/extend-auth"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
func (a *SSODeviceAuthorizationApiService) Security10OidcDeviceAuthenticatePost(ctx _context.Context) (InitDeviceAuthResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  InitDeviceAuthResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/security/1.0/oidc/device/authenticate"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
